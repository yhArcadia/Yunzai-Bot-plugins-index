...
| [清凉图插件 (yunzai-c-v-plugin)](https://gitee.com/xwy231321/yunzai-c-v-plugin) | [@xwy](https://gitee.com/xwy231321) | | ✔ | 清凉图插件，发送随机图片(正经二三次元图、b站404漫画、戳一戳返回mc酱图片或清理内存(Linux生效),图片转卡片 |
