...
| [开发插件 (develop-plugins)](https://gitee.com/ningmengchongshui/develop-plugins) | [@柠檬冲水](https://gitee.com/ningmengchongshui)|  | ✔ | 开发插件模板（内涵游戏开发）若有同志愿鼎力相助可推送优化 |
...
| 名称  |  作者  | 支持v2 | 支持v3 | 备注  |
|-------| ----- | ------ | ------|------ |
| [光遇插件 (SKY-GuangYu-plugin)](https://gitee.com/Tloml-Starry/SKY-GuangYu-plugin) | [@Tloml-Starry](https://giett.com/Tloml-Starry) | | ✔ | 提供光遇的辅助功能,后续内容待更新 |
...
| [修仙插件 (xiuxian-plugin)](https://gitee.com/ningmengchongshui/xiuxian-extensions) | [@三点水](https://gitee.com/ningmengchongshui/xiuxian-extensions/blob/master/organization/README.md) |   | ✔ | 多人在线文游 |
