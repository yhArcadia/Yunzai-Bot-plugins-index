...
| [自动化插件 (auto-plugin)](https://gitee.com/Nwflower/auto-plugin) | [@西北一枝花](https://gitee.com/Nwflower/) |   | ✔ | 一些乱七八糟的自动化小功能 |
...
|-------| ----- | ------ | ------|------|-------|
| [日程插件](https://github.com/ldcivan/daily_info_plugin) | [@YujioNako](https://github.com/ldcivan) | | ✔ | [V3](https://raw.githubusercontent.com/ldcivan/daily_info_plugin/main/daily_info.js) | 一个日程（定时）提醒js插件，优先为大学生设计 |
