...
| 名称  |  作者  | 备注  |
|-------| ----- |------ |
| [Lofter插件 (Lofter-Plugin)](https://github.com/WindDrift/Lofter-Plugin) | [@WindDrift](https://github.com/WindDrift) | 适用于 Yunzai-Bot v3 和 TRSS-Yunzai 的 Lofter 博文解析插件，支持自动解析博文内容、提取文字和高清原图。 |
