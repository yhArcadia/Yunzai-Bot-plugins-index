...
| 名称  |  作者  | 支持v2 | 支持v3 | 备注  |
|-------| ----- | ------ | ------|------ |
| [互殴插件（Fisticuffs-Plugin）](https://gitee.com/JK_An0nymou5/fisticuffs-plugin)|[@JK_An0nymou5](https://gitee.com/JK_An0nymou5)|-|✔|[脆脆鲨插件](https://gitee.com/JMCCS/jinmaocuicuisha) 的打架骂人强化版，另外提供master管理等功能|
