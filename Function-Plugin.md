...
| 名称  |  作者  | 备注  |
|-------| ----- |------ |
| [who-are-you-plugin](https://github.com/yhArcadia/who-are-you-plugin) | [@渔火Arcadia](https://github.com/yhArcadia) | 群成员**头像**、**昵称**记录留档工具，有效制裁群友“改头换面”、秽土转生。(如链接打不开请把github换成gitee) |
...
| [榴莲插件 (liulian-plugin)](https://gitee.com/huifeidemangguomao/liulian-plugin) |[@会飞的芒果猫](https://gitee.com/huifeidemangguomao) [@萧枘](https://gitee.com/xiaoxiaorurui) | 提供B站推送、热搜推送、原神地下地图、插件管理等一些拓展功能及原神/星铁/绝区零/异环/鸣潮**猜角色**、娶群友、随机表情、星座运势、话痨统计、天气、多群广播消息等群聊（娱乐）功能 |
