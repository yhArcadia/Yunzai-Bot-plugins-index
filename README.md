...
| [Xs-plugin](https://gitee.com/hsxfk/Xs-plugin) | [@其实雨很好](https://gitee.com/actually-the-rain-is-good)[@黄色小方块](https://gitee.com/hsxfk) | 本插件还在开发中，只有一些比较简单的功能  ps：开学力，更新变慢力（悲 |
...
| [AI绘图插件(mj-plugin)](https://github.com/ap-plugin/mj-plugin) | [@0卡苏打水](https://github.com/CikeyQi)  [@erzaozi](https://github.com/erzaozi) | 又一个AI绘图插件，使用Midjourney接口，实现在QQ内使用Midjourney生成图片 |
...
| [榴莲插件 (liulian-plugin)](https://gitee.com/huifeidemangguomao/liulian-plugin) |[@会飞的芒果猫](https://gitee.com/huifeidemangguomao)[@萧枘](https://gitee.com/xiaoxiaorurui) | 提供原神地下地图、B站推送、插件管理等一些拓展功能及原神/星铁猜角色、娶群友、随机表情、星座运势、话痨统计、天气、多群广播消息等群聊功能(部分功能需要在云崽根目录下执行`pnpm install -P`安装依赖或安装图片加量包以保证正常使用) |
...
| [Linux签名API安装脚本](https://gitee.com/Alan_Brown/sign-easy) | [@古都 雨冬 寒夜](https://gitee.com/Alan_Brown) | 提供用于Linux（云服务器、手机Termux）的签名API安装脚本（可能支持所有Linux版本？） |
