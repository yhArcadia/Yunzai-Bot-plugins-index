...
| [清凉图插件 (yunzai-c-v-plugin)](https://gitee.com/xwy231321/yunzai-c-v-plugin) | [@xwy](https://gitee.com/xwy231321) | | ✔ | 清凉图插件，发送随机图片(正经二三次元图、b站404漫画、戳一戳返回mc酱图片或清理内存(Linux生效),图片转卡片,体力卡片等 |
...
| [花生插件 (huasheng)](https://gitee.com/huasheng1999/huasheng) | [@huasheng](https://gitee.com/huasheng1999) | | ✔ |  各种角色的语音（4类），bot拉黑词，小爱ai，计算睡眠时间等功能. |
...
| [绝云间修仙模拟器V1.2.4「银花造福盈」 (原修仙模拟器DD斩首魔改版)](https://gitee.com/hutao222/DDZS-XIUXIAN-V1.2.4) | [@DD斩首](https://gitee.com/hutao222) |   | ✔ | 基于基于 xiuxian-emulator-pluginV1.2.1爆改，功能数量比2.0全插件版本多35个功能以及新年版本活动「银花造福盈」将于1月20日上线 |
