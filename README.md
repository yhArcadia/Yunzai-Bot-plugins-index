...
| 名称  |  作者  | 支持v2 | 支持v3 | 备注  |
|-------| ----- | ------ | ------|------ |
| [AI语音本地生成(vits_yunzai_plugin)](https://gitee.com/sumght/vits_yunzai_plugin) | [@sumght-z](https://github.com/sumght-z) | ✔ | ✔ | 基于vits本地生成原神(genshin)语音，可以自行添加更多模型进行更多音色语音合成 [github地址](https://github.com/sumght-z/vits_yunzai_plugin)|
...
| [全服获取Ck或Stoken_1.5.apk](https://wwd.lanzouj.com/i05nv0brec6b) | [@DivinationHW](https://gitee.com/DivinationHW) | 蓝奏云密码：4b0b 用于获取国际服国服Cookie和Stoken |
